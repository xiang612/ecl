...
float HK0 = vn - vwn;
float HK1 = ve - vwe;
float HK2 = powf(HK0, 2) + powf(HK1, 2) + powf(vd, 2);
float HK3 = powf(HK2, -1.0F/2.0F);
float HK4 = HK0*HK3;
float HK5 = HK1*HK3;
float HK6 = 1.0F/HK2;
float HK7 = HK0*P(4,6) - HK0*P(6,22) + HK1*P(5,6) - HK1*P(6,23) + P(6,6)*vd;
float HK8 = HK1*P(5,23);
float HK9 = HK0*P(4,5) - HK0*P(5,22) + HK1*P(5,5) - HK8 + P(5,6)*vd;
float HK10 = HK1*HK6;
float HK11 = HK0*P(4,22);
float HK12 = HK0*P(4,4) - HK1*P(4,23) + HK1*P(4,5) - HK11 + P(4,6)*vd;
float HK13 = HK0*HK6;
float HK14 = -HK0*P(22,23) + HK0*P(4,23) - HK1*P(23,23) + HK8 + P(6,23)*vd;
float HK15 = -HK0*P(22,22) - HK1*P(22,23) + HK1*P(5,22) + HK11 + P(6,22)*vd;
float HK16 = HK3/(-HK10*HK14 + HK10*HK9 + HK12*HK13 - HK13*HK15 + HK6*HK7*vd + R_TAS);
